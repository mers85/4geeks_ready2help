			...
			<div className="row mx-auto">
				<div className="col-sm-12 col-md-10 mx-auto">
					...
					<div className="card p-md-4 py-4 border-0 shadow">
						<h2 className="card-title text-center p-3">Datos Complementarios</h2>
						<small className="card-subtitle p-2 text-center">
							Sólo debes cumplimentar estos datos si deseas realizar una donación y/o querer participar
							como voluntario.
						</small>
